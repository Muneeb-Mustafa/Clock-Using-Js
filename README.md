A simple Clock built using HTML, CSS, and JavaScript that dynamically displays the current time. The clock updates every second, showing hours, minutes, and seconds in real-time.
